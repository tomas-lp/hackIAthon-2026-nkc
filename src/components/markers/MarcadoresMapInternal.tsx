...
export default function MarcadoresMapInternal({
  ...
  return (
    ...
    >
      ...
      {isCreating && (
        <div className="absolute top-4 left-1/2 -translate-x-1/2 z-[1000] bg-white/95 backdrop-blur-md px-4 py-2 rounded-full shadow-lg border border-gray-200 flex items-center gap-2 animate-in fade-in slide-in-from-top-3 duration-200 pointer-events-none">
      ...
      <div className="absolute bottom-4 left-4 z-[999] hidden sm:flex items-center gap-3 bg-white/90 backdrop-blur-md rounded-full px-3.5 py-1.5 border border-gray-200 shadow-sm text-xs font-medium text-zinc-700">
        <span className="font-semibold text-zinc-900">Referencias</span>
        ...
        <div className="flex items-center gap-1.5">
          <div className="h-3 w-3 rounded-sm bg-red-500 flex items-center justify-center text-white text-[9px] font-bold">
            +
          </div>
            ...
            >
              ...
              <Popup className="custom-marker-popup">
                <div className="p-1 min-w-[200px] text-xs">
                  <div className="flex items-center gap-1.5 mb-1.5 font-bold text-zinc-900 border-b border-gray-100 pb-1">
                    {marker.category === "EVACUACION" ? (
                  ...
                  <div className="flex flex-col gap-1 text-zinc-600">
                    ...
                    {marker.direccion && (
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-zinc-700 text-right truncate max-w-[140px]">
                          {marker.direccion}
                        </span>
                      </div>
                    )}
                    ...
                    {marker.localidad && (
                      <div className="flex items-center justify-between">
                        <span className="text-zinc-400">Localidad:</span>
                    ...
                    {marker.capacidad_maxima !== null &&
                      marker.capacidad_maxima !== undefined && (
                        <div className="flex items-center justify-between text-emerald-700 font-semibold mt-1 pt-1 border-t border-gray-100">
