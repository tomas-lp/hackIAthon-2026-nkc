        ...
        safeZone={
          ...
          healthSel.selectedHealthCenter.lon !== null
            ? {
                ...
                nombre: healthSel.selectedHealthCenter.nombre,
                descripcion: "",
                direccion: healthSel.selectedHealthCenter.direccion,
                localidad: healthSel.selectedHealthCenter.localidad,
                departamento: healthSel.selectedHealthCenter.departamento,
                provincia: healthSel.selectedHealthCenter.provincia,
