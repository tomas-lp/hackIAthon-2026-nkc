    ...
    >
      ...
      {isAdmin && (
        <button
          ...
          title="Mostrar panel"
          className="fixed left-0 top-6 z-[100] flex items-center justify-center rounded-r-xl border border-l-0 border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-1.5 py-3 text-gray-400 dark:text-slate-400 shadow-md transition-all duration-300 ease-in-out hover:bg-gray-50 dark:hover:bg-slate-700 hover:text-gray-600 dark:hover:text-slate-200 cursor-pointer"
          style={{
            transform:
