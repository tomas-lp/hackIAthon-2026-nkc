...
CREATE OR REPLACE FUNCTION "public"."get_reports_nearby"("p_lon" double precision, "p_lat" double precision, "p_radius" double precision) RETURNS integer
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  nearby_count INTEGER;
BEGIN
  -- ST_DWithin calcula si los puntos están a menos de p_radius metros de distancia
...
ALTER FUNCTION "public"."get_reports_nearby"("p_lon" double precision, "p_lat" double precision, "p_radius" double precision) OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."user_sessions"
    ADD CONSTRAINT "user_sessions_pkey" PRIMARY KEY ("chat_id");
...
GRANT ALL ON FUNCTION "public"."get_reports_nearby"("p_lon" double precision, "p_lat" double precision, "p_radius" double precision) TO "anon";
GRANT ALL ON FUNCTION "public"."get_reports_nearby"("p_lon" double precision, "p_lat" double precision, "p_radius" double precision) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_reports_nearby"("p_lon" double precision, "p_lat" double precision, "p_radius" double precision) TO "service_role";
